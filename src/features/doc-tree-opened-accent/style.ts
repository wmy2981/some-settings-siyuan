...
const SAFE_COLOR = /^(#[0-9a-fA-F]{3,8}|[a-zA-Z-]+|(rgb|rgba|hsl|hsla|oklch|oklab|lab|lch|color-mix|var)\([^;{}"']*\))$/;
...
const buildCss = (color: string, width: number): string => `/* 文档树中当前打开笔记的左缘强调色 */
